...
#All data types include non-detections
...
# Import KORA photo csv

Lynx<-fread("ZS_Lynx_occurence.csv", select=c(
  "exposure_date",
  "exposure_time",
...
Mother<-fread("Mummy_lynx.csv", select=c("mother","fofaID","yearOfBirth"))
...
# -- Occurence table (occurence species) ####
Period = 5 #Period in days
simultaneous = 30 #minutes
